...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "original_name",
                    models.CharField(
                        help_text="Source name in original catalog", max_length=128
                    ),
                ),
                (
                    "metadata",
                ...
                (
                    "confidence",
                    models.FloatField(
                        default=1.0, help_text="Cross-match confidence (0.0-1.0)"
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="source",
            index=models.Index(
                fields=["primary_catalog"], name="sources_sou_primary_catalog_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="catalogentry",
            index=models.Index(
                fields=["catalog_name"], name="sources_cat_catalog_name_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="catalogentry",
