...
export function HomePage() {
  ...
  const features = [
    {
      ...
      description:
        "Interaktywna mapa 3D obiektów kosmicznych z możliwością filtrowania i szczegółowych informacji",
      path: "/universe-map",
    ...
    },
    {
      ...
      description:
        "Przeglądaj i filtruj źródła promieniowania gamma z katalogów astronomicznych",
      path: "/sources",
    ...
    },
    {
      ...
      description:
        "Zaawansowana analityka katalogów: emisja, istotność statystyczna i porównania",
  ...
  return (
    <main className="min-h-screen w-full flex flex-col text-white bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative">
      <CosmicParticles />
      <div
        className="container mx-auto px-4 py-16 flex-1 flex flex-col relative"
        style={{ zIndex: 1 }}
      >
        {/* Hero Section */}
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-base md:text-lg text-slate-400 max-w-2xl mx-auto mt-4">
            Platforma do analizy i wizualizacji źródeł promieniowania gamma z
            katalogów Fermi, HAWC, LHAASO, NED, TeVCat i MAGIC
          </p>
        </div>
